...
SHARED_LAMBDA_LAYER_ARN="arn:aws:lambda:ap-southeast-1:229965290704:layer:dev-Jolteon-shared-layer:1"
...
verifyInstallation() {
    printHeader;
    printSeparator;
    printColored "Jolteon - Backend CLI";
    printSeparator;
    printColored "Releasing Jolteon chatbot backend using ${ENVIRONMENT}.env";
    printSeparator;
